QUESTÃO 2
Implemente o padrão estrutural Adapter em Java no contexto de uma calculadora, capaz 
de executar operações com números binários e decimais. Para tanto, considere que já 
exista uma calculadora binária no mercado, com as seguintes operações: 
