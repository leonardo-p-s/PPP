...
possíveis, use Queijo, Tomate, Ovo e quaisquer outras que você desejar. Considere que, 
para cada pizza, deve ser possível obter a descrição (detalhes de todos os ingredientes que 
compõem a pizza) e o custo. Crie uma classe Pizzaria que contém o método main para 
